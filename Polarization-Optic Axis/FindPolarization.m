...
[Maxima, MaxIdx] = findpeaks(dIIdttnorm,ttnorm,'MinPeakDistance',.3,'MinPeakHeight',.01);
[Minima, MinIdx] = findpeaks(-dIIdttnorm,ttnorm,'MinPeakDistance',.3,'MinPeakHeight',.01);
Minima = -Minima;
...
figure(1)
findpeaks(dIIdttnorm, ttnorm, 'MinPeakDistance',.3,'MinPeakHeight',.01)
xlabel('time (s)')
